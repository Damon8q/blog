...
有时候一个句子的定语很长，按公式翻译之后，不好理解，这时候可以做一定的处理，让句子更好懂。

> **举例说明：**
>
> * `Social science is that branch of intellectual(脑力的，智力的) enquiry(探索) which seeks to(追求，力求) study humans and their endeavors(追求) in the same reasoned(逻辑的), orderly(条理的), systematic(体系的), and dispassioned(理性的) manner that natural scientists(自然科学家) use for the study of natural phenomena(自然现象).`
>
>   **分析**： 这个句子也是个长句，首先也看看有没有并列，分析发现有2个，第一个`study humans and their endeavors`，这是一个“单黄蛋”的宾语并列；第二个`in the same reasoned, orderly, systematic, and dispassioned manner` 这只是一个并列的词组，顺序翻译即可。 接下来分析主干： `Social science`句子开头独立名词结构，因此是主语，接着就是`is`动词，因此是谓语，`that branch of...`名词结构，因此是宾语，又由于没有其他影响句子结构的并列结构，所以句子主干就是：`Social science is that branch` 后面的都是对`branch`的修饰，即定语。只是这个定语有些长，但不管有多长，我们都按公式来翻译即可，将定语内部按短语结构进行倒序和并列不变序进行翻译。
>
>   **傻傻翻译：** 社会科学就是自然科学家用来学习自然现象，力求学习人类以及他们所追求的有相同目的的， 有逻辑的， 有条理的探索智力的分支，和一种理性的方法。
>
>   **直译：** 社会科学是 为自然现象研究中自然科学家用到的 以相同有逻辑有条理有体系并且理性的方法 力求研究人类和他们的追求的 一种智力探索的那样一个分支。 
>
>   **分析2：** 这个句子直译后，感觉句子也不好懂，原因在于定语太长了，话说了半天都还不知道到底想说啥，这就是中文句子结构的问题，英语不存在此问题，因为它一开始就先把结论说了，然后才是修饰补充。因此像让中文句子好懂，遇到此情况，有个技巧就是把这个长定语截断，分两句或多句进行描述, 在大概中间的位置按短语切开即可。具体方法就是在分开的地方加上：`这个 + 宾语(名词) ...`
>
>   **翻译2：** 社会科学是力求研究人类和他们的追求的一种智力探索的那样一个分支，**这个分支** 是自然现象研究中自然科学家用到的以相同有逻辑有条理有体系并且理性的方法。
