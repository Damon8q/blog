...
>
>   **分析2：** 这个句子直译后，感觉句子也不好懂，原因在于定语太长了，话说了半天都还不知道到底想说啥，这就是中文句子结构的问题，英语不存在此问题，因为它一开始就先把结论说了，然后才是修饰补充。因此像让中文句子好懂，遇到此情况，有个技巧就是把这个长定语截断，分两句或多句进行描述, 在大概中间的位置按短语切开即可。具体方法就是在分开的地方加上：`这个 + 宾语(名词) ...`。 短语之间的连接词，以及介词如何翻译的问题，就看什么词合适用什么，没有具体的标准。
>
